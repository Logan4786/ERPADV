...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `registro_oab` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `cargo` char(11) COLLATE utf8_unicode_ci NOT NULL,
  `nome` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `rg` varchar(9) COLLATE utf8_unicode_ci NOT NULL,
  `cpf` char(15) COLLATE utf8_unicode_ci NOT NULL,
  `endereço` char(200) COLLATE utf8_unicode_ci NOT NULL,
